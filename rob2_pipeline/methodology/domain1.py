...
DOMAIN1_METHODOLOGY = DomainMethodology(
    ...
    rule_cards={
        "1.1": RuleCard(
            ...
            {
                "Y": ResponseRule(
                    "A random component is explicitly described, including computer generation, random tables, chance devices, or minimization with a random element."
                ),
                "PY": ResponseRule(
                    "A large or well-run trial lacks details but context supports random generation and no predictable method is suggested."
                ),
                "PN": ResponseRule(
                    "Context suggests possible non-random methods and the current report does not clarify."
                ),
                "N": ResponseRule(
                    "The sequence is predictable or non-random, such as alternation, dates, record numbers, clinician decisions, or availability."
                ),
                "NI": ResponseRule(
                    "The report only states that the study was randomized and provides no useful contextual basis for PY/PN."
                ),
            },
        ...
        "1.2": RuleCard(
            ...
            {
                "Y": ResponseRule(
                    "Remote, central, pharmacy-controlled, telephone/internet allocation, or adequately protected envelopes/containers prevented foreknowledge."
                ),
                "PY": ResponseRule(
                    "Concealment is strongly implied by restricted access, central control, or trial infrastructure even if operational detail is incomplete."
                ),
                "PN": ResponseRule(
                    "The method is incomplete and suggests possible inadequacy, such as envelopes without enough safeguards."
                ),
                "N": ResponseRule(
                    "Enrolling investigators or participants could know or predict the forthcoming allocation."
                ),
                "NI": ResponseRule(
                    "No useful allocation concealment information is available."
                ),
            },
        ...
        "1.3": RuleCard(
            ...
            {
                "Y": ResponseRule(
                    "Substantial group-size discrepancies, excess significant imbalances, important prognostic imbalance, or excessive similarity suggest a randomization problem."
                ),
                "PY": ResponseRule(
                    "Baseline patterns suggest a possible randomization problem but are not conclusive."
                ),
                "PN": ResponseRule(
                    "Minor imbalances are unlikely to indicate material bias."
                ),
                "N": ResponseRule(
                    "No important imbalances are apparent or observed imbalances are compatible with chance."
                ),
