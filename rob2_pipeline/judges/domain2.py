def judge_domain2(sq: dict) -> tuple[str, str]:
    ...
    def _part1():
        ...
        if either_aware and s22 in ("Y", "PY") and s23 in ("N", "PN"):
            return "Some concerns", "2.3=N/PN (no trial-context deviations) -> Part1=Some concerns"
        ...
        return "Some concerns", f"Fallback: 2.1={s21} 2.2={s22} 2.3={s23} 2.4={s24} 2.5={s25}"
    ...
    def _part2():
        ...
        return "Some concerns", f"Fallback: 2.6={s26} 2.7={s27}"
